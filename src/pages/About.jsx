  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-purple-50 pt-20">
      ...
      <section className="bg-gradient-to-br from-pink-50 via-purple-50 to-teal-50 py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000"></div>
        
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-pink-300 shadow-sm">
              <span className="w-2 h-2 bg-pink-600 rounded-full animate-pulse"></span>
              <span className="text-pink-800 text-sm font-medium">SINCE 2018</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">Creative Elephant</span>
            </h1>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <span className="text-pink-600 font-semibold bg-pink-100 px-4 py-2 rounded-full">ABOUT US</span>
              <h2 className="text-4xl font-bold text-gray-800 mt-6 mb-6">
                Company Background
              </h2>
            </div>
            
            <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl p-8 md:p-12 shadow-lg border border-pink-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="text-center bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-4 mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="text-center bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-4 mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="text-center bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                <div className="w-16 h-16 bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl flex items-center justify-center text-white text-2xl mb-4 mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl border border-purple-200">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                <div className="flex-shrink-0">
                  <div className="w-32 h-32 bg-gradient-to-br from-pink-600 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-xl border-4 border-white">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="space-y-6 text-gray-700 leading-relaxed">
                    <p className="flex items-start">
                      <HiAcademicCap className="text-pink-500 mr-3 mt-1 flex-shrink-0 text-xl" />
                      <span>
                    ...
                    <div className="bg-pink-50 rounded-xl p-6 border-l-4 border-pink-500 shadow-sm">
                      <h4 className="font-semibold text-lg text-gray-800 mb-4 flex items-center">
                        <FaBrain className="text-pink-600 mr-2" /> Experience? Got It.
                      </h4>
                      <p className="mb-4">
                      ...
                      <p className="text-pink-700 font-semibold text-lg italic bg-white p-4 rounded-xl border border-pink-200 flex items-start">
                    ...
                    <div className="bg-purple-50 rounded-xl p-6 border-l-4 border-purple-500 shadow-sm">
                      <h4 className="font-semibold text-lg text-gray-800 mb-4 flex items-center">
                        <FaHandshake className="text-purple-600 mr-2" /> People First, Always
                      </h4>
                      <p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <span className="text-purple-600 font-semibold bg-purple-100 px-4 py-2 rounded-full">OUR VALUES</span>
              <h2 className="text-4xl font-bold text-gray-800 mt-6 mb-6">
                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">Core Values</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={index} className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                  <div className={`w-16 h-16 bg-gradient-to-br ${value.color} rounded-2xl flex items-center justify-center text-white text-2xl mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                    <value.icon />
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8">
              Why Choose <span className="text-teal-300">Creative Elephant</span>
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left mb-12">
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-teal-500 rounded-full flex items-center justify-center text-sm font-bold shadow-lg">
            ...
            <div className="text-xl text-pink-100 italic max-w-2xl mx-auto bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <FaQuoteLeft className="text-teal-300 mb-4 text-2xl" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              {[
                ...
                <div key={index} className="flex items-center space-x-4 p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition-colors group border border-purple-200">
                  <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform">
