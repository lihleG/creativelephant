...
const Services = () => {
  // Updated Print Services Data with React Icons (Packaging & Boxes removed)
  const printServices = [
    {
      icon: FaIdCard,
    ...
    // Removed Packaging & Boxes service
  ];

  // Updated Design Services Data with Website Design removed
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-purple-50 pt-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">Services</span>
            </h1>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-pink-600 font-semibold bg-pink-100 px-4 py-2 rounded-full">PRINT SERVICES</span>
            <h2 className="text-4xl font-bold text-gray-800 mt-6 mb-6">
              Print <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">Services</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {printServices.map((service, index) => (
              <div 
                key={index}
                className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group"
              >
                ...
                <h3 className="text-2xl font-semibold text-gray-800 mb-4 group-hover:text-purple-700 transition-colors">
                  {service.title}
                </h3>
                ...
                <ul className="space-y-2 mb-6">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center text-sm text-gray-700">
                      <FaCheck className="w-3 h-3 text-purple-500 mr-3 flex-shrink-0" />
                      {feature}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-purple-600 font-semibold bg-purple-100 px-4 py-2 rounded-full">DESIGN SERVICES</span>
            <h2 className="text-4xl font-bold text-gray-800 mt-6 mb-6">
              Design <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">Services</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-pink-600 font-semibold bg-pink-100 px-4 py-2 rounded-full">OUR PROCESS</span>
            <h2 className="text-4xl font-bold text-gray-800 mt-6 mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">Process</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="bg-white rounded-2xl p-8 max-w-2xl mx-auto mb-8 shadow-xl">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4 flex items-center justify-center">
              <FaUpload className="text-pink-600 mr-3" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="#contact"
                className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="#contact"
              className="bg-white text-pink-700 hover:bg-pink-50 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center"
            >
            ...
            <a 
              href="#contact"
              className="border-2 border-white text-white hover:bg-white hover:text-pink-700 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center"
            >
          ...
          {/* Contact Info */}
          <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-6 text-pink-100 text-sm">
          ...
          <div className="mt-8 bg-white bg-opacity-20 rounded-xl p-4 max-w-2xl mx-auto backdrop-blur-sm border border-white/20">
            <p className="text-pink-100 text-sm flex items-center justify-center">
