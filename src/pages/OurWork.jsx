...
const ThreeScene = () => {
  return (
    <Canvas className="absolute inset-0">
      ...
      <FloatingShape position={[-2, 0, 0]} color="#8B5CF6" />
      <FloatingShape position={[2, 1, 0]} color="#EC4899" />
      <FloatingShape position={[0, -1, 0]} color="#F59E0B" />
...
const OurWork = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-pink-50 pt-20">
      ...
      <section className="py-20 lg:py-32 relative overflow-hidden bg-gradient-to-br from-purple-600 to-pink-600 text-white">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-pink-300">Creative Work</span>
            </h1>
            ...
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-white text-purple-600 font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={index} className="group">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center text-white text-2xl mb-4 mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <stat.icon />
                </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredClients.map((client, index) => (
              <div
                key={client.id}
                className={`bg-white rounded-2xl p-6 shadow-lg border border-purple-100 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group ${
              ...
              >
                ...
                <div className={`h-32 bg-gradient-to-br ${client.color} rounded-xl mb-6 relative overflow-hidden flex items-center justify-center text-white font-bold text-xl p-4 shadow-lg`}>
                  {client.featured && (
                    <div className="absolute top-3 right-3 bg-amber-400 text-amber-900 px-2 py-1 rounded-full text-xs font-semibold flex items-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <button className="flex items-center space-x-2 bg-purple-50 hover:bg-purple-100 text-purple-700 px-4 py-2 rounded-lg transition-colors duration-300 group-hover:translate-x-1">
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-12 text-white shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-purple-600 hover:bg-purple-50 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
                  Start Your Project
                </button>
